        ...
        return $form
            ->schema([
                ...
                Forms\Components\FileUpload::make('driving_license_image')
                    ->image(),
                Forms\Components\FileUpload::make('car_license_image')
                    ->image(),
                Forms\Components\DatePicker::make('car_license_expiry_date'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\ImageColumn::make('car_license_image'),
                Tables\Columns\TextColumn::make('car_license_expiry_date')
                    ->date()
                    ->sortable(),
