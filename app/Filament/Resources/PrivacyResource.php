...
class PrivacyResource extends Resource
{
    ...
    protected static ?int $navigationSort = 4; // بعد Terms في الـ Sidebar

    // public static function canAccess(): bool
    // {
    //     return auth()->user()->hasPermissionTo('manage-privacy', 'web');
    // }
    ...
    public static function form(Form $form): Form
    {
        ...
        return $form->schema([
            Forms\Components\TextInput::make('slug')
                ...
                ->helperText(__('رابط ثابت للصفحة مثل privacy')),
